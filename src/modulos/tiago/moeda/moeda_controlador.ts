...
import { criarServico, alterarServico, buscarServico, buscarTodosServico, removerServico } from './moeda_servico';

export const criar = async (req: Request, res: Response) => {
    const parametros = { nome: req.body.nome, moeda: req.body.moeda };
...
export const alterar = async (req: Request, res: Response) => {
    const parametros = { id: req.params.id, nome: req.body.nome, moeda: req.body.moeda };
